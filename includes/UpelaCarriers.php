...
class UpelaCarriers
{
    ...
    protected function setGroups( $oCarriers, $aGroups, $bDelete = true )
    {
        ...
        $sQuery = 'INSERT INTO ' . _DB_PREFIX_ . 'carrier_group (id_carrier, id_group) VALUES ' . implode(
                ',',
                $aValues
            );
    ...
    {
        $sSource = _PS_MODULE_DIR_ . $this->module_name . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . 'img' . DIRECTORY_SEPARATOR . 'carriers' . DIRECTORY_SEPARATOR . 'logo-' . Tools::strtolower(
                $carrierCode
            ) . '.jpg';
